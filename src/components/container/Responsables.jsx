...
import Directrice from "../../assets/Mme_AMANY.png";
    ...
    <div className='section' id='teacher'>
        <div className="grid sm:grid-cols-2 place-items-center gap-8">
            ...
            <div className="font-bold sm:text-[1.875rem] text-[1.5rem] text-white mb-5">
                Mme. <span className='text-SkyBlue'>Jessica AMANY</span> <br />Directrice
            </div>
            ...
            <img src={Directrice} className='w-full border rounded-md' alt="" />
            </div>
